...
mixin _$SystemLogModel {
 ...
 String get id; String get source; String? get description;@JsonKey(name: 'category') LogCategory get category;@JsonKey(name: 'code') String? get code;@JsonKey(name: 'log_level') LogLevel get logLevel;@JsonKey(name: 'environment') Environment get environment; Map<String, dynamic> get payload;@JsonKey(name: 'response_status', unknownEnumValue: ResponseStatus.unresponded) ResponseStatus get responseStatus;@JsonKey(name: 'created_at') DateTime get createdAt;@JsonKey(name: 'current_responder_id') String? get currentResponderId;@JsonKey(name: 'current_responder_name') String? get currentResponderName;@JsonKey(name: 'response_started_at') DateTime? get responseStartedAt;@JsonKey(name: 'organization_id') String? get organizationId;@JsonKey(name: 'assigned_by_id') String? get assignedById;@JsonKey(name: 'assigned_by_name') String? get assignedByName;@JsonKey(name: 'is_muted') bool? get isMuted;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,source,description,category,code,logLevel,environment,const DeepCollectionEquality().hash(payload),responseStatus,createdAt,currentResponderId,currentResponderName,responseStartedAt,organizationId,assignedById,assignedByName,isMuted);

@override
String toString() {
  return 'SystemLogModel(id: $id, source: $source, description: $description, category: $category, code: $code, logLevel: $logLevel, environment: $environment, payload: $payload, responseStatus: $responseStatus, createdAt: $createdAt, currentResponderId: $currentResponderId, currentResponderName: $currentResponderName, responseStartedAt: $responseStartedAt, organizationId: $organizationId, assignedById: $assignedById, assignedByName: $assignedByName, isMuted: $isMuted)';
}
...
class _SystemLogModel implements SystemLogModel {
  const _SystemLogModel({required this.id, required this.source, this.description, @JsonKey(name: 'category') this.category = LogCategory.event, @JsonKey(name: 'code') this.code, @JsonKey(name: 'log_level') this.logLevel = LogLevel.info, @JsonKey(name: 'environment') this.environment = Environment.production, final  Map<String, dynamic> payload = const {}, @JsonKey(name: 'response_status', unknownEnumValue: ResponseStatus.unresponded) this.responseStatus = ResponseStatus.unresponded, @JsonKey(name: 'created_at') required this.createdAt, @JsonKey(name: 'current_responder_id') this.currentResponderId, @JsonKey(name: 'current_responder_name') this.currentResponderName, @JsonKey(name: 'response_started_at') this.responseStartedAt, @JsonKey(name: 'organization_id') this.organizationId, @JsonKey(name: 'assigned_by_id') this.assignedById, @JsonKey(name: 'assigned_by_name') this.assignedByName, @JsonKey(name: 'is_muted') this.isMuted}): _payload = payload;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,source,description,category,code,logLevel,environment,const DeepCollectionEquality().hash(_payload),responseStatus,createdAt,currentResponderId,currentResponderName,responseStartedAt,organizationId,assignedById,assignedByName,isMuted);
