...
mixin _$SystemLogModel {
 ...
 String get id; String get source; String? get description;@JsonKey(name: 'category') LogCategory get category;@JsonKey(name: 'code') String? get code;@JsonKey(name: 'log_level') LogLevel get logLevel;@JsonKey(name: 'environment') Environment get environment; Map<String, dynamic> get payload;@JsonKey(name: 'response_status', unknownEnumValue: ResponseStatus.unresponded) ResponseStatus get responseStatus;@JsonKey(name: 'created_at') DateTime get createdAt;@JsonKey(name: 'current_responder_id') String? get currentResponderId;@JsonKey(name: 'current_responder_name') String? get currentResponderName;@JsonKey(name: 'response_started_at') DateTime? get responseStartedAt;@JsonKey(name: 'organization_id') String? get organizationId;@JsonKey(name: 'assigned_by_id') String? get assignedById;@JsonKey(name: 'assigned_by_name') String? get assignedByName;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,source,description,category,code,logLevel,environment,const DeepCollectionEquality().hash(payload),responseStatus,createdAt,currentResponderId,currentResponderName,responseStartedAt,organizationId,assignedById,assignedByName);

@override
String toString() {
  return 'SystemLogModel(id: $id, source: $source, description: $description, category: $category, code: $code, logLevel: $logLevel, environment: $environment, payload: $payload, responseStatus: $responseStatus, createdAt: $createdAt, currentResponderId: $currentResponderId, currentResponderName: $currentResponderName, responseStartedAt: $responseStartedAt, organizationId: $organizationId, assignedById: $assignedById, assignedByName: $assignedByName)';
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String source,  String? description, @JsonKey(name: 'category')  LogCategory category, @JsonKey(name: 'code')  String? code, @JsonKey(name: 'log_level')  LogLevel logLevel, @JsonKey(name: 'environment')  Environment environment,  Map<String, dynamic> payload, @JsonKey(name: 'response_status', unknownEnumValue: ResponseStatus.unresponded)  ResponseStatus responseStatus, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'current_responder_id')  String? currentResponderId, @JsonKey(name: 'current_responder_name')  String? currentResponderName, @JsonKey(name: 'response_started_at')  DateTime? responseStartedAt, @JsonKey(name: 'organization_id')  String? organizationId, @JsonKey(name: 'assigned_by_id')  String? assignedById, @JsonKey(name: 'assigned_by_name')  String? assignedByName)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SystemLogModel() when $default != null:
return $default(_that.id,_that.source,_that.description,_that.category,_that.code,_that.logLevel,_that.environment,_that.payload,_that.responseStatus,_that.createdAt,_that.currentResponderId,_that.currentResponderName,_that.responseStartedAt,_that.organizationId,_that.assignedById,_that.assignedByName);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String source,  String? description, @JsonKey(name: 'category')  LogCategory category, @JsonKey(name: 'code')  String? code, @JsonKey(name: 'log_level')  LogLevel logLevel, @JsonKey(name: 'environment')  Environment environment,  Map<String, dynamic> payload, @JsonKey(name: 'response_status', unknownEnumValue: ResponseStatus.unresponded)  ResponseStatus responseStatus, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'current_responder_id')  String? currentResponderId, @JsonKey(name: 'current_responder_name')  String? currentResponderName, @JsonKey(name: 'response_started_at')  DateTime? responseStartedAt, @JsonKey(name: 'organization_id')  String? organizationId, @JsonKey(name: 'assigned_by_id')  String? assignedById, @JsonKey(name: 'assigned_by_name')  String? assignedByName)  $default,) {final _that = this;
switch (_that) {
case _SystemLogModel():
return $default(_that.id,_that.source,_that.description,_that.category,_that.code,_that.logLevel,_that.environment,_that.payload,_that.responseStatus,_that.createdAt,_that.currentResponderId,_that.currentResponderName,_that.responseStartedAt,_that.organizationId,_that.assignedById,_that.assignedByName);case _:
  throw StateError('Unexpected subclass');
...
class _SystemLogModel implements SystemLogModel {
  const _SystemLogModel({required this.id, required this.source, this.description, @JsonKey(name: 'category') this.category = LogCategory.event, @JsonKey(name: 'code') this.code, @JsonKey(name: 'log_level') this.logLevel = LogLevel.info, @JsonKey(name: 'environment') this.environment = Environment.production, final  Map<String, dynamic> payload = const {}, @JsonKey(name: 'response_status', unknownEnumValue: ResponseStatus.unresponded) this.responseStatus = ResponseStatus.unresponded, @JsonKey(name: 'created_at') required this.createdAt, @JsonKey(name: 'current_responder_id') this.currentResponderId, @JsonKey(name: 'current_responder_name') this.currentResponderName, @JsonKey(name: 'response_started_at') this.responseStartedAt, @JsonKey(name: 'organization_id') this.organizationId, @JsonKey(name: 'assigned_by_id') this.assignedById, @JsonKey(name: 'assigned_by_name') this.assignedByName}): _payload = payload;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,source,description,category,code,logLevel,environment,const DeepCollectionEquality().hash(_payload),responseStatus,createdAt,currentResponderId,currentResponderName,responseStartedAt,organizationId,assignedById,assignedByName);
