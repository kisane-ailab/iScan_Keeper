...
@override
String toString() {
  return 'HealthCheckState(productionLogs: $productionLogs, developmentLogs: $developmentLogs, productionAlertCount: $productionAlertCount, developmentAlertCount: $developmentAlertCount, productionFilter: $productionFilter, developmentFilter: $developmentFilter)';
}
...
class _HealthCheckState implements HealthCheckState {
  const _HealthCheckState({final  List<SystemLogEntity> productionLogs = const [], final  List<SystemLogEntity> developmentLogs = const [], this.productionAlertCount = 0, this.developmentAlertCount = 0, this.productionFilter = const EnvironmentFilterState(), this.developmentFilter = const EnvironmentFilterState()}): _productionLogs = productionLogs,_developmentLogs = developmentLogs;
