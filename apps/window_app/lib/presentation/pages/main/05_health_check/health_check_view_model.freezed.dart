...
@override
String toString() {
  return 'HealthCheckState(productionLogs: $productionLogs, developmentLogs: $developmentLogs, productionAlertCount: $productionAlertCount, developmentAlertCount: $developmentAlertCount, availableSources: $availableSources, availableCodes: $availableCodes, selectedSource: $selectedSource, selectedCode: $selectedCode, selectedLogLevels: $selectedLogLevels, startDate: $startDate, endDate: $endDate)';
}
...
class _HealthCheckState implements HealthCheckState {
  const _HealthCheckState({final  List<SystemLogEntity> productionLogs = const [], final  List<SystemLogEntity> developmentLogs = const [], this.productionAlertCount = 0, this.developmentAlertCount = 0, final  List<String> availableSources = const [], final  List<String> availableCodes = const [], this.selectedSource, this.selectedCode, final  Set<LogLevel> selectedLogLevels = const {}, this.startDate, this.endDate}): _productionLogs = productionLogs,_developmentLogs = developmentLogs,_availableSources = availableSources,_availableCodes = availableCodes,_selectedLogLevels = selectedLogLevels;
